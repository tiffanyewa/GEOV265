...
% 2b)
    ...
    fprintf('\n')
    fprintf('The  North america side of Þingvellir relative to the European plate \n')
    fprintf('\n')
    fprintf('The relative motion of the plates is: %s cm/yr \n', num2str(velocity1))
...
%% 2c)
   ...
   lon = points(:,2);
    ...
    % subplot; Upper plot showing how the velocity varies from 0° to -50°, 
    % as a sinusoid
...
% 3b)
    ...
    % north america-africa: 
        ...
        % around. going from 78.8 N and 38.3 E => to 78.8 S and 141.7 W
        % angulatt degree: 2.4
